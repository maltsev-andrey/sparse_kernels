...
*Part of my GPU computing portfolio demonstrating sparse linear algebra optimization. See also: [CUDA Matrix Multiplication](../linear-algebra/gemm), [N-Body Simulation](../simulation/n-body)*
